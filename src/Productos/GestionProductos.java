...
public class GestionProductos extends JFrame {
    ...
    public GestionProductos() {
        ...
        btnNuevo.addActionListener(e -> {
            ...
            dlg.getContentPane().add(new OpcionesProducto());
            dlg.pack();
    ...
    private void mostrarDialogoEditar() {
        ...
        JButton btnSeleccionar = Botones.crear("Seleccionar", DORADO, DORADO_CLARO);
    ...
    private void cargarProductos() {
        ...
        try (Connection con = ConexionBD.conectar();
             PreparedStatement ps = con.prepareStatement("SELECT id,nombre,categoria,precio,stock FROM productos");
             ResultSet rs = ps.executeQuery();
             PreparedStatement ps2 = con.prepareStatement("SELECT COUNT(DISTINCT categoria) total FROM productos");
