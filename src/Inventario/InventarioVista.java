...
public class InventarioVista extends JFrame {
    ...
    public InventarioVista() {
        ...
        setTitle("CAFECOMETA ERP - INVENTARIO");
        setSize(1200, 700);
    ...
    private void eliminarInsumo() {
        ...
        try (Connection con = ConexionBD.conectar()) {
            con.prepareStatement("DELETE FROM movimientos_insumos WHERE id_insumo = " + id).executeUpdate();
            con.prepareStatement("DELETE FROM recetas WHERE id_insumo = " + id).executeUpdate();
            con.prepareStatement("DELETE FROM insumos WHERE id = " + id).executeUpdate();
    ...
    private static InventarioVista instancia;

    public static void abrir() {
        if (instancia == null || !instancia.isDisplayable()) {
            instancia = new InventarioVista();
        }
